...
//==================================================================================================
// UTF-8 POLISH CHARACTER MAPPING
//==================================================================================================
...
void drawMainScreen() {
  ...
  // ========== ATOMIC READ - Fast mutex lock/unlock (optimization) ==========
  ...
  portEXIT_CRITICAL(&wsMux);  // Fast unlock!  (~100us instead of 2ms)
  
  // ========== Work with local copies (no mutex needed) ==========
    ...
    if (doc. containsKey("payload")) {
      ...
      for (JsonObject obj : arr) {
        ...
        if (strcmp(id, "nameset") == 0) {
          ...
          // Filter status messages (PROGMEM strings)
