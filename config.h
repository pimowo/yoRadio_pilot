...
// yoRadio IPs - extern declarations
extern const char* RADIO_IPS[];
...
#define VOLUME_DISPLAY_TIME 2000         // 2 sekundy wyświetlania głośności
...
// WEBSOCKET SETTINGS
//==================================================================================================
#define WS_TIMEOUT_MS 10000              // 10 sekund timeout WebSocket
#define WS_RECONNECT_INTERVAL_MS 3000    // 3 sekundy retry (było 5000)

//==================================================================================================
// RADIO SWITCH DISPLAY TIME
//==================================================================================================
// This can be added if needed for radio switching display duration
